 ...
 * This is particularly useful in shared environments where some resources are provisioned manually or by other teams, and we need to reference them in our Terraform-managed infrastructure.
